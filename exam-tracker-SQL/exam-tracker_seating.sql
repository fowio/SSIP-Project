...
CREATE TABLE `seating` (
  ...
  CONSTRAINT `seating_ibfk_1` FOREIGN KEY (`exam_id`) REFERENCES `exams` (`exam_id`),
  CONSTRAINT `seating_ibfk_2` FOREIGN KEY (`student_id`) REFERENCES `users` (`user_id`)
...
INSERT INTO `seating` VALUES (1,5,'A1');
